...
class Global_model extends CI_Model {
    ...
    function get_attendance_by_class_id_alpha($table_name, $id) {
        $this->db->select('name,id,attendance');
        $this->db->where('class_id', $id);
    ...
    function get_points_by_class_id($table_name, $id) {
        $this->db->where('class_id', $id);
        $this->db->select('id,name,total_points');
    ...
    function get_current_lesson(){
        ...
        return $this->db->get('lessons')->row();
    }
    
    function get_current_lesson_questions(){
        $current_lesson= $this->get_current_lesson();
         $this->db->where('lesson_id', $current_lesson->id);
         return $this->db->get('lessons_questions')->result();
        
    }

    function get_data_from_ns($s_id,$date){
       $this->db->where('s_id',$s_id);
       $this->db->where('date',$date);
       return $this->db->get('spiritual_note')->result();
   }
}
